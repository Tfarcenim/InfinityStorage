...
public class InfinityChestScreen extends GuiContainer {
  ...
  private TileInfiniteStorage te;
  private InventoryPlayer playerinventory;

  public InfinityChestScreen(InfinityChestContainer container, InventoryPlayer playerinventory) {
    super(container);
