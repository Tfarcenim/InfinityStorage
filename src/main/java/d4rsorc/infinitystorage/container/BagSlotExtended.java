...
public class BagSlotExtended extends Slot {

  private static IInventory emptyInventory = new InventoryBasic("[Null]", true, 0);
  private final InfinityBagHandler itemHandler;
  private final int index;

  public BagSlotExtended(InfinityBagHandler itemHandler, int index, int xPosition, int yPosition) {
  ...
  public InfinityBagHandler getItemHandler() {
    return itemHandler;
  }

  @Override
  public boolean isSameInventory(Slot other) {
    return other instanceof BagSlotExtended && ((BagSlotExtended) other).getItemHandler() == this.itemHandler;
  }
}