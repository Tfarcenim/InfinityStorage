...
public class SlotExtended extends Slot {
  ...
  private final InfinityHandler itemHandler;
  private final int index;

  public SlotExtended(InfinityHandler itemHandler, int index, int xPosition, int yPosition) {
  ...
  public InfinityHandler getItemHandler() {
    return itemHandler;
  }
